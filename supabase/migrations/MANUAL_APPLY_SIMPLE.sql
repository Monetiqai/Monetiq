-- ============================================================================
-- SIMPLIFIED MANUAL MIGRATION - PART 1
...
-- IMPORTANT: Replace <YOUR_SERVICE_ROLE_KEY> with your actual key from .env.local
...
SELECT 'RLS enabled on generations' as check, 
       (SELECT relrowsecurity FROM pg_class WHERE relname = 'generations') as result
UNION ALL
